...
export declare function create(
    userSessionInfo: any
): Promise<import("../interfaces/user.interface").IUserSession>;
/**
 *
 * @param {Object} query
 */
export declare function findOne(
    query: any
): Promise<import("../interfaces/user.interface").IUserSession | null>;
/**
 *
...
export declare function findById(
    userSessionId: Schema.Types.ObjectId
): Promise<import("../interfaces/user.interface").IUserSession | null>;
/**
 *
 * @param filters
 * @param update
 */
export declare function findOneAndUpdateUpsert(
    filters: any,
    update: any
): Promise<{
    ok: number;
